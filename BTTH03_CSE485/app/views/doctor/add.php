    ...
    <div class="row">
      <div class="col-md-12 d-flex justify-content-center">
        <div class="wrapped w-25 mt-5">
          <form method="POST" action="?controller=doctor&action=add">
            <div class="mb-3">
              <label for="id" class="form-label">Mã bác sĩ</label>
              <input type="text" name="id" id="id" class="form-control">
            </div>
            <div class="mb-3">
              <label for="fullname" class="form-label">Tên bác sĩ</label>
              <input type="text" name="nameDoctor" id="nameDoctor" class="form-control">
            </div>
            <div class="mb-3">
              <label for="fullname" class="form-label">Chuyên khoa</label>
