...
<body>
    ...
    <div class="container">
        ...
        <a href="<?=DOMAIN."/public/index.php?controller=patient&action=addForm"?>"class ='btn btn-success'>ADD</a>
        <table class="table">
  <thead>
    <tr>
  ...
  <tbody>
    <?php
     foreach($allPatient as $each){
     ?>
        <tr>
            <th scope="row"><?= $each->getId(); ?></th>
            <td><?= $each->getName(); ?></td>
            <td><?= $each->getDate(); ?></td>
            <td><?= $each->getSignal(); ?></td>
            <td><?= $each->getIdDoctor(); ?></td>
            <td>
              <a href="<?= DOMAIN.'/public/index.php?controller=patient&action=edit&id=' .$each->getId(); ?>"><i class="bi bi-pencil-square"></i></a>
            </td>
            <td>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <a class="btn btn-primary" href="<?= DOMAIN."/public/index.php?controller=patient&action=delete&id=".$each->getId(); ?>">Delete</a>
                    </div>
                  </div>
                </div>
              </div>
